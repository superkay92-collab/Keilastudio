...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/keilasstudioextension",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@keilasstudioextension",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/keilasstudioextension",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  return (
    <footer className="bg-charcoal text-cream/80 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-sm text-cream/50 leading-relaxed max-w-xs">
              ...
              and bundles. Quality you can feel, beauty you can see.
            </p>
            <div className="mt-6 space-y-1.5 text-sm text-cream/50">
              <p>📍 Accra, Ghana 🇬🇭</p>
              <p>📞 +233 XX XXX XXXX</p>
              <p>✉️ hello@keilastudioextension.com</p>
            </div>
            {/* Social Media */}
          ...
          {/* Shop */}
          <div>
            <h4 className="text-xs font-semibold tracking-widest uppercase text-cream mb-5">
              Shop
            </h4>
            <ul className="space-y-3 text-sm text-cream/50">
              {[
                ...
                { label: "Closures", href: "/shop?category=closures" },              { label: "Nails", href: "/shop?category=nails" },              ].map((l) => (
                <li key={l.href}>
        ...
        {/* Bottom bar */}
        <div className="border-t border-cream/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-cream/30">
          <p>© {new Date().getFullYear()} Keila&apos;s Studio Extension. All rights reserved.</p>
          <p>Payments secured by Paystack &amp; Flutterwave · MoMo accepted</p>
        </div>
      </div>
    </footer>
  );
